        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary text-capitalize">@lang('messages_be.service_list')</h6>
                    <a href="{{route('our-services-add')}}" class="btn btn-primary">@lang('messages_be.service_add')</a>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <table class="table" id="datatable">
                        <thead>
                            <tr>
                                <th>@lang('messages_be.service_input_title')</th>
                                <th>@lang('messages_be.service_input_description')</th>
                                <th>Banner</th>
