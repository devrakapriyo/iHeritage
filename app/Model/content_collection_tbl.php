...
class content_collection_tbl extends Model
{
    ...
    public static function listCollectionMetaTopic($id, $topic, $limit)
    {
        return self::where('id', "!=", $id)->where('topic', $topic)->where('is_active',"Y")->orderBy('id','desc')->take($limit)->get();
    }
