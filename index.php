...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="maintenance/fonts/iconic/css/material-design-iconic-font.min.css">
    <!--===============================================================================================-->
...
<div class="flex-w flex-str size1 overlay1">
    <div class="flex-w flex-col-sb wsize1 bg0 p-l-70 p-t-37 p-b-52 p-r-50 respon1">
        <div class="wrappic1">
            <a href="#">
                <img src="public/bootstrap/vendor/iheritage.png" alt="IMG">
            </a>
        </div>
    ...
    <div class="wsize2 bg-img1 respon2" style="background-image: url('public/bootstrap/asset-img/heritage-place/prambanan.jpg');">
    </div>
</div>
