            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary text-capitalize">@lang('messages_be.news_edit')</h6>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('news-update', ['id'=>$id])}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>@lang('messages_be.news_input_title') (bahasa inggriss) : </label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>@lang('messages_be.news_input_description') (bahasa inggriss) : </label>
