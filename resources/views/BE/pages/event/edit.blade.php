        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form method="post" action="{{route('event-update')}}" multiple="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="start_date" class="form-control" value="{{$detail->start_date}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="end_date" class="form-control" value="{{$detail->end_date}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="long_description_ind" class="form-control" row="5">{!! $detail->long_description_ind !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Long Description (Bahasa Inggris): </label>
                                        <textarea name="long_description_en" class="form-control" row="5">{!! $detail->long_description_en !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="close_registration" class="form-control" value="{{$detail->close_registration}}">
