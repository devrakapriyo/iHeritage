            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary text-capitalize">edit content</h6>
                        ...
                        <form method="post" action="{{route('content-update',['category'=>$category,'id'=>$id])}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="category_ctn_id" class="form-control">
                                            @foreach(App\Model\category_content_tbl::listCategory($category) as $item)
                                                <option {{$content->category_ctn_id == $item->id ? "selected" : ""}} value="{{$item->id}}">{{$item->category_ctn_name_ind}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Address:</label>
                                        <input type="text" name="map_area_detail" class="form-control" id="location" value="{{$content->location}}" onchange="check_location()">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Address : </label>
                                        <textarea name="address" class="form-control" row="3">{!! $detail->address !!}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="long_description_ind" class="form-control" row="5">{!! $content->long_description_ind !!}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Long Description (Bahasa Inggris): </label>
                                        <textarea name="long_description_en" class="form-control" row="5">{!! $content->long_description_en !!}</textarea>
                                    </div>
                                </div>
                            </div>
