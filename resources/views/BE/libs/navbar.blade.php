<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
        <a class="nav-link dropdown-toggle text-dark" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-globe fa-fw"></i> @lang('messages.collection_lang')
        </a>
        <!-- Dropdown - Alerts -->
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
        <h6 class="dropdown-header">
            @lang('messages_be.info_switch_lang')
        </h6>
        ...
        <a class="dropdown-item d-flex align-items-center" href="{{url('locale/id')}}">
            <div class="mr-3">
    ...
    <li class="nav-item dropdown no-arrow">
        ...
        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
            ...
            @lang('messages_be.logout_btn_logout')
        </a>
        </div>
    </li>
